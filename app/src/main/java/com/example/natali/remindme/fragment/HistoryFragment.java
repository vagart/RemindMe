...
import com.example.natali.remindme.adapter.RemindmeListAdapter;
...
public class HistoryFragment extends AbstractTabFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rv.setAdapter(new RemindmeListAdapter(createMocRemindListData()));

        return view;
    }

    private List<RemindDTO> createMocRemindListData() {
